...
namespace LanguageToClasses.Converters
{
    public class XmlConverter : AbstractConverter
    {
        ...
        public override List<AbstractNode> Convert(string source)
        {
            ...
            Queue<(Models.XmlNode node, Status innerText)> nodes = new Queue<(Models.XmlNode node, Status innerText)>(new (Models.XmlNode node, Status innerText)[]{
                (null, new Status(){
                    DefaultNamespace = "",
                    InnerText = source,
            ...
            (Models.XmlNode node, Status status) lastQueueItem = default;
        ...
        private Models.XmlNode getNode(string source, Models.XmlNode parent, Dictionary<string, string> namespaces, string defaultNamespace)
        {
            Match match = Regex.Match(source, $"{elementStartTag}");
            if (!match.Success)
                return null;

            Models.XmlNode newNode = new Models.XmlNode();
        ...
        //Models.XmlNode root = new Models.XmlNode()
        //{
        //	Name = "root",
        //	ValueType = "Root"
        //};
        ...
        //(Models.XmlNode node, Status status) lastNode = default;
        ...
        private Models.XmlNode ProcessTag(string tag, Models.XmlNode parent, ref Dictionary<string, string> namespaces, ref string defaultNamespace)
        {
            Models.XmlNode node = new Models.XmlNode();
        ...
        private void ProcessAttributes(string attributesAsString, Models.XmlNode actual, Dictionary<string, string> namespaces, ref string defaultNamespace)
        {
            var attributes = new List<Models.XmlAttribute>();
            ...
            foreach (Match attributeMatch in stringAttributes)
            {
                ...
                {
                    Models.XmlAttribute attribute = new Models.XmlAttribute()
                    {
                        Name = atrName,
